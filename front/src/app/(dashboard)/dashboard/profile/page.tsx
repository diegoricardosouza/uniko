...
import { CheckCircle, Loader2, Lock, Mail, ShieldUserIcon, User, UserRoundCog } from "lucide-react";
import { BreadcrumbProfile } from "../_components/BreadcrumbProfile";
import { useProfileController } from "./useProfileController";

export default function UserEdit() {
  const { form, handleSubmit, isLoading } = useProfileController()
            ...
            <Card>
              <CardHeader className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <CardTitle className="text-xl">Editar Meu Perfil</CardTitle>
                    <CardDescription>Preencha os dados para editar seu perfil no sistema</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
