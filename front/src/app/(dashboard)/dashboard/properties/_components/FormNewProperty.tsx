...
import { useNewPropertiesController } from "../new/useNewPropertiesController";
      ...
      <Card>
        <CardHeader className="space-y-1">
          <div className="flex items-center gap-4">
            ...
            <div>
              <CardTitle className="text-xl">Novo Imóvel do site</CardTitle>
              <CardDescription>Crie um novo imóvel para o seu site</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
