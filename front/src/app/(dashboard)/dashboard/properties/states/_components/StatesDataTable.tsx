...
import { useStatesController } from "../useStatesController";
import { useColumnsStates } from "./useColumnsStates";
...
export function StatesDataTable({ states, isLoading }: UsersDataTableProps) {
  ...
  const columnsUser = useColumnsStates(handleDelete, handleEdit);
      ...
      <div className="flex">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="sm:max-w-md" onOpenAutoFocus={(e) => e.preventDefault()} onCloseAutoFocus={(e) => e.preventDefault()}>
            <DialogHeader>
              <DialogTitle>
                {editingCategory ? "Editar Estado" : "Nova Estado"}
              </DialogTitle>
              <DialogDescription>
                {editingCategory
                  ? "Atualize as informações da categoria"
                  : "Crie um novo estado para seus imóveis"
                }
              </DialogDescription>
            </DialogHeader>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Type className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                          <Input placeholder="Digite a sigla" className="pl-10" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
      ...
      <div className="w-full min-h-[300px] relative overflow-hidden">
        ...
        <div>
          <div className="flex items-center justify-between gap-2 py-4">
            ...
            <span className="text-sm">{states.length} itens</span>
          </div>
