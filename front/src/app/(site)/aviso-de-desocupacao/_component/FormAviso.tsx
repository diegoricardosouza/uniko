...
import { avisoDesocupacaoSchema } from "@/schemas/avisoDesocupacaoSchema";
...
type FormData = z.infer<typeof avisoDesocupacaoSchema>
...
export function FormAviso() {
  ...
  const form = useForm<FormData>({
    resolver: zodResolver(avisoDesocupacaoSchema),
    defaultValues: {
      name: "",
      email: "",
      phone: "",
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    try {
      ...
      const html = `
          ...
          <b>Data Pretendida: </b>${data.codeContract}<br>
          <b>Motivo desocupação: </b><br> ${data.reason}</p>
        `

      const payload = {
        name: "Aviso de Desocupação",
        to: "diegoricardoweb@gmail.com",
        subject: "Aviso de Desocupação via site",
        htmlContent: html
      }
          ...
          <div className="space-y-[10px]">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input placeholder="Data pretendida" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="space-y-[9px] mt-[10px] md:mt-0">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Textarea placeholder="Motivo da desocupação" {...field} className="!h-[208px]" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
