...
export function FormContato() {
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    try {
      ...
      const html = `
          ...
          <b>Mensagem: </b><br> ${data.message}</p>
        `
  ...
  return (
    <Form {...form}>
      ...
      <form onSubmit={handleSubmit} className="form-contato mt-10">
                ...
                <FormItem>
                  <FormControl>
                    <div className="flex gap-[7px] items-start">
                      ...
                      >
                        Autorizo o tratamento dos meus dados pessoais de forma livre e
                        esclarecida na Política de Privacidade e nos Termos de Uso. Conforme
